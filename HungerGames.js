...
HungerGames.prototype.onServerInit = function(gameServer) {
    ...
    gameServer.config.foodMaxAmount = 12500;
    gameServer.config.foodMass = 5; // Food is not scarce, but its worth more
    ...
    // Food
    this.spawnFood(gameServer,500,{x: mapWidth * .5,y: mapHeight * .5}); // Center
